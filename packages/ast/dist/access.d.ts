...
export type BasicAuthMethod = "oauth2" | "api_key" | "mtls" | "service_account" | "anonymous";
...
export type GdprDpBasis = "consent" | "contract" | "legitimate_interest" | "legal_obligation" | "vital_interest" | "public_task";
/** Lawful basis for processing — GDPR builtins get autocomplete; custom bases allowed. */
export type DpBasis = GdprDpBasis | (string & {});
export type BasicIntentOp = "read" | "write" | "delete" | "transform" | "export" | "audit";
