...
export type Expression = FilterExpr | ProjectionExpr | AggregationExpr | GroupKeyExpr | JoinCondExpr | SortExpr | SplitRoutesExpr | GuardPolicyExpr;
export type FilterExpr = PortableFilter | SqlFilter | MongoFilter | KafkaFilter | CustomFilter | FunctionRef;
export type PortableFilter = CompareExpr | InListExpr | BetweenExpr | IsNullExpr | LikeExpr | ExistsExpr | AndExpr | OrExpr | NotExpr;
...
export type ProjectionEntry = SelectAll | ExcludeField | SelectField | ComputedField;
...
export type ScalarExpr = FieldRefExpr | LiteralExpr | ArithmeticExpr | CoalesceExpr | CaseWhenExpr;
...
export type BasicAggFn = "COUNT" | "SUM" | "AVG" | "MIN" | "MAX" | "FIRST" | "LAST" | "COLLECT";
...
export type GuardPolicyExpr = PortablePolicy | ExternalPolicyRef | FunctionRef;
export type PortablePolicy = ContextCompare | HasCheck | PolicyAnd | PolicyOr | PortableFilter;
